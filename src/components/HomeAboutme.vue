    ...
    <div id="aboutme-wrapper" class="flex gap-8">
      <div class="relative w-full">
        ...
        <h2 class="text-5xl mt-8">
          I'm <b>Marco</b>. A&nbsp;developer, an optimist and problem solver.
        </h2>
        ...
        <button
          id="read-more"
          class="my-24 rounded-xl p-2 inline-block cursor-pointer transition-transform hover:scale-105 duration-300 bg-callToAction"
        ...
        <p v-if="aboutMePersonal" class="mt-4 text-xl">
          Apart from coding I try to spend as much time in nature as possible. I
          enjoy reading books like "Unlimited Memory" by Kevin Horsley or
          "Limitless" by Jim Kwik.<br />In my holidays I like to travel.
          Especially to places with unique landscapes. And I enjoy engaging in
          physically demanding sports that require focus, such as climbing.<br />But
          none of these things can compare to having dinner with friends and
          playing a great strategy board game like Catan afterward.
        </p>
      </div>
